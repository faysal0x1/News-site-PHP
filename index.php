        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $sql = "select post.post_id,post.title,post.author,post.description,post.post_date,post.category,category.category_name,user.username ,post.post_img from post 
